...
namespace KC.WindowsConfigurationAnalyzer.Contracts;
    ...
    public enum ParameterType { String, Int, Bool, Date, Array }
    ...
    public enum SubsystemType { Registry, FileSystem, ETW, ACL, Profile }
...
[JsonConverter(typeof(JsonStringEnumConverter))]
    public enum ExpressionType { Comparison, Logical, Regex, Math, FunctionCall, LambdaExpression , Predicate, RegexMatch, Contains, Script , ETWProbe, AclEvaluation, HashVerification}
    ...
    public enum ActionType { Log, Notify, Mark, Task }
