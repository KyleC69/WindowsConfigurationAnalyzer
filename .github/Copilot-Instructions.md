...
**Solution Structure**:
  - DataProbe project contains the data collection logic. TODO: Includes some static analysis logic that should be removed and leave pure gathering.
  - Root : Shared project for collection of miscellaneous files not tied to a project
  - RulesEngineStore - File system folder that contains rules for the RulesEngine library.
  - RuleAnalyzer - Main library project for the Microsoft RulesEngine library. Logical core of the analyzer. Methods should be asynchronous.
  - UserInterface - Contains User Interface, WinuUI 3 based .net 9.0 project. Logic should be constrained to UI concerns only. Keep operational logic to their respective libraries.
...
- AI should analyze requests in the context of the entire project to ensure consistency and coherence.
- AI should also analyze requests for potentially better approaches or patterns to achieve the same goal.
