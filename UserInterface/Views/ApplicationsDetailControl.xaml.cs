...
public sealed partial class ApplicationsDetailControl : UserControl
{
    ...
    public static readonly DependencyProperty ListDetailsMenuItemProperty = DependencyProperty.Register("ListDetailsMenuItem", typeof(SampleOrder), typeof(ApplicationsDetailControl), new PropertyMetadata(null, OnListDetailsMenuItemPropertyChanged));
