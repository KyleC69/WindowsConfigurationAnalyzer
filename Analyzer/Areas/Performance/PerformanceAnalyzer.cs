...
public sealed class PerformanceAnalyzer : IAnalyzerModule
{
	...
	public Task<AreaResult> AnalyzeAsync(IAnalyzerContext context, CancellationToken cancellationToken)
	{
		...
		var cpuAll = new List<Dictionary<string, object?>>();
		var memCounters = new Dictionary<string, object?>();
		var systemCounters = new Dictionary<string, object?>();
		var disks = new List<Dictionary<string, object?>>();
		var pagingFiles = new List<Dictionary<string, object?>>();
		var topProcCpu = new List<Dictionary<string, object?>>();
		var topProcMem = new List<Dictionary<string, object?>>();
		...
		try
		{
			...
			var proc = new List<Dictionary<string, object?>>();
			foreach (var row in context.Cim.Query(
